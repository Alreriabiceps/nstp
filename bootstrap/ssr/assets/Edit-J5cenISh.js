    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight"${_scopeId}> Edit Student </h2>`);
          } else {
            return [
              createVNode("h2", { class: "font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight" }, " Edit Student ")
            ];
          }
        }),
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></div><div class="flex items-center justify-between border-t dark:border-gray-700 mt-4 pt-4"${_scopeId}><div${_scopeId}><button type="button" class="inline-flex items-center px-3 py-1.5 bg-yellow-500 hover:bg-yellow-700 text-white text-sm font-medium rounded-md"${_scopeId}> Reset Password </button></div><div class="flex items-center space-x-2"${_scopeId}><a${ssrRenderAttr("href", _ctx.route("students.index"))} class="inline-flex items-center px-3 py-1.5 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-md"${_scopeId}> Cancel </a>`);
