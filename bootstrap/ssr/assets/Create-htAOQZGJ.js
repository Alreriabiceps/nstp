    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="font-semibold text-xl text-gray-800 leading-tight"${_scopeId}> Add Student </h2>`);
          } else {
            return [
              createVNode("h2", { class: "font-semibold text-xl text-gray-800 leading-tight" }, " Add Student ")
            ];
          }
        }),
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$4, {
              class: "mt-2",
              message: unref(form).errors.birthdate
            }, null, _parent2, _scopeId));
            ...
            _push2(`<select id="course_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" autofocus required${_scopeId}><option hidden value=""${ssrIncludeBooleanAttr(Array.isArray(unref(form).course_id) ? ssrLooseContain(unref(form).course_id, "") : ssrLooseEqual(unref(form).course_id, "")) ? " selected" : ""}${_scopeId}> Select Course </option><!--[-->`);
            ...
            _push2(`<select id="enrollment_year" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" autofocus required${_scopeId}><option value="" hidden${ssrIncludeBooleanAttr(Array.isArray(unref(form).enrollment_year) ? ssrLooseContain(unref(form).enrollment_year, "") : ssrLooseEqual(unref(form).enrollment_year, "")) ? " selected" : ""}${_scopeId}> Select Year </option><!--[-->`);
