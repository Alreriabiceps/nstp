...
import { _ as _sfc_main$9 } from "./AuthenticatedLayout-Bg1mrgu1.js";
      ...
      _push(ssrRenderComponent(_sfc_main$9, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<!--]--></select></div><div class="w-1/3"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$a, {
              for: "semester",
              value: "Semester"
            }, null, _parent2, _scopeId));
            _push2(`<select id="semester" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" name="semester" value=""${_scopeId}><option value="" hidden${ssrIncludeBooleanAttr(Array.isArray(unref(searchForm).semester) ? ssrLooseContain(unref(searchForm).semester, "") : ssrLooseEqual(unref(searchForm).semester, "")) ? " selected" : ""}${_scopeId}> Please Select Semester </option><option value="first"${ssrIncludeBooleanAttr(Array.isArray(unref(searchForm).semester) ? ssrLooseContain(unref(searchForm).semester, "first") : ssrLooseEqual(unref(searchForm).semester, "first")) ? " selected" : ""}${_scopeId}> First Semester </option><option value="second"${ssrIncludeBooleanAttr(Array.isArray(unref(searchForm).semester) ? ssrLooseContain(unref(searchForm).semester, "second") : ssrLooseEqual(unref(searchForm).semester, "second")) ? " selected" : ""}${_scopeId}> Second Semester </option></select></div></div><div class="flex mb-4 space-x-4"${_scopeId}><div class="w-1/3"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$a, {
              for: "school_year",
              value: "School Year"
            }, null, _parent2, _scopeId));
            ...
            _push2(`<select id="status" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" name="status" value=""${_scopeId}><option value="" hidden${ssrIncludeBooleanAttr(Array.isArray(unref(searchForm).status) ? ssrLooseContain(unref(searchForm).status, "") : ssrLooseEqual(unref(searchForm).status, "")) ? " selected" : ""}${_scopeId}> Please Select Status </option><option value="complete"${ssrIncludeBooleanAttr(Array.isArray(unref(searchForm).status) ? ssrLooseContain(unref(searchForm).status, "complete") : ssrLooseEqual(unref(searchForm).status, "complete")) ? " selected" : ""}${_scopeId}> Complete </option><option value="incomplete"${ssrIncludeBooleanAttr(Array.isArray(unref(searchForm).status) ? ssrLooseContain(unref(searchForm).status, "incomplete") : ssrLooseEqual(unref(searchForm).status, "incomplete")) ? " selected" : ""}${_scopeId}> Incomplete </option></select></div></div><button type="submit" class="py-2 px-2 bg-blue-500 hover:bg-blue-700 text-white rounded"${_scopeId}> Filter `);
            ...
            _push2(` Select all </button><a href="#" id="updateStatusButton" class="py-2 px-2 bg-pink-500 hover:bg-pink-700 text-white rounded text-sm"${_scopeId}>Update Status</a><a href="#" id="downloadCertificateButton" class="py-2 px-2 bg-indigo-500 hover:bg-indigo-700 text-white rounded text-sm"${_scopeId}>`);
            ...
            if (updateStatusModal.value) {
              _push2(`<div${_scopeId}><div class="fixed inset-0 flex items-center justify-center z-50"${_scopeId}><div class="bg-white rounded-lg p-8"${_scopeId}><h2 class="text-xl font-semibold mb-4"${_scopeId}> Update Status </h2><form method="POST"${_scopeId}><div class="mb-4"${_scopeId}><label for="first_semester" value="First Semester"${_scopeId}></label>`);
              _push2(ssrRenderComponent(_sfc_main$a, {
                for: "first_semester",
                value: "First Semester"
              }, null, _parent2, _scopeId));
              _push2(`<select id="first_semester" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" name="first_semester"${_scopeId}><option value="" hidden${ssrIncludeBooleanAttr(Array.isArray(
                unref(downloadCertificateForm).first_sem_status
              ) ? ssrLooseContain(
                unref(downloadCertificateForm).first_sem_status,
                ""
              ) : ssrLooseEqual(
                unref(downloadCertificateForm).first_sem_status,
                ""
              )) ? " selected" : ""}${_scopeId}> Please Select Status </option><option value="passed"${ssrIncludeBooleanAttr(Array.isArray(
                unref(downloadCertificateForm).first_sem_status
              ) ? ssrLooseContain(
                unref(downloadCertificateForm).first_sem_status,
                "passed"
                ...
                unref(downloadCertificateForm).first_sem_status,
                "passed"
              )) ? " selected" : ""}${_scopeId}> Passed </option><option value="failed"${ssrIncludeBooleanAttr(Array.isArray(
                unref(downloadCertificateForm).first_sem_status
              ) ? ssrLooseContain(
                unref(downloadCertificateForm).first_sem_status,
                "failed"
                ...
                unref(downloadCertificateForm).first_sem_status,
                "failed"
              )) ? " selected" : ""}${_scopeId}> Failed </option></select>`);
              _push2(ssrRenderComponent(_sfc_main$b, {
                class: "mt-2",
                message: unref(downloadCertificateForm).errors.first_sem_status
              }, null, _parent2, _scopeId));
              ...
              _push2(`<select id="second_semester" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" name="second_semester"${_scopeId}><option value="" hidden${ssrIncludeBooleanAttr(Array.isArray(
                unref(downloadCertificateForm).second_sem_status
              ) ? ssrLooseContain(
                unref(downloadCertificateForm).second_sem_status,
                ""
              ) : ssrLooseEqual(
            ...
            ssrRenderList(__props.students, (student) => {
              ...
              ) ? " checked" : ""}${ssrRenderAttr("value", student.id)}${_scopeId}></td><td class="px-2 py-1 whitespace-nowrap text-xs"${_scopeId}>${ssrInterpolate(student.seq_no)}</td><td class="px-2 py-1 whitespace-nowrap text-xs"${_scopeId}>${ssrInterpolate(student.student_id)}</td><td class="px-2 py-1 whitespace-nowrap text-sm"${_scopeId}>${ssrInterpolate(student.last_name + ", " + student.first_name + " " + student.middle_name)}</td><td class="px-2 py-1 whitespace-nowrap text-sm"${_scopeId}>${ssrInterpolate(student.course ? student.course.code : "")}</td><td class="px-2 py-1 whitespace-nowrap text-xs"${_scopeId}>${ssrInterpolate(student.enrollment_type)}</td><td class="px-2 py-1 whitespace-nowrap text-xs"${_scopeId}>${ssrInterpolate(student.enrollment_year)}</td><td class="px-2 py-1 whitespace-nowrap text-xs"${_scopeId}>`);
              if (student.first_sem_status && student.second_sem_status) {
                _push2(`<div class="text-green-500"${_scopeId}> Complete </div>`);
              } else {
                _push2(`<div class="text-red-500"${_scopeId}> Incomplete </div>`);
              }
              _push2(`</td><td class="px-2 py-1 whitespace-nowrap text-sm space-x-2"${_scopeId}><a${ssrRenderAttr("href", `/students/${student.id}`)} class="text-blue-500 hover:text-blue-700"${_scopeId}>`);
              ...
              createVNode("div", { class: "py-12" }, [
                createVNode("div", { class: "max-w-7xl mx-auto sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "bg-white overflow-hidden shadow-sm sm:rounded-lg" }, [
                        ...
                        createVNode("div", { class: "flex mb-4 space-x-4" }, [
                          ...
                          createVNode("div", { class: "w-1/3" }, [
                            ...
                            withDirectives(createVNode("select", {
                              ...
                              name: "semester",
                              value: "",
                              "onUpdate:modelValue": ($event) => unref(searchForm).semester = $event
                            }, [
                              createVNode("option", {
                                value: "",
                                hidden: ""
                              }, " Please Select Semester "),
                              createVNode("option", { value: "first" }, " First Semester "),
                              createVNode("option", { value: "second" }, " Second Semester ")
                            ], 8, ["onUpdate:modelValue"]), [
                              [vModelSelect, unref(searchForm).semester]
                            ])
                          ])
                        ]),
                        createVNode("div", { class: "flex mb-4 space-x-4" }, [
                          ...
                          createVNode("div", { class: "w-1/3" }, [
                            ...
                            withDirectives(createVNode("select", {
                              ...
                              createVNode("option", { value: "complete" }, " Complete "),
                              createVNode("option", { value: "incomplete" }, " Incomplete ")
                            ], 8, ["onUpdate:modelValue"]), [
                              [vModelSelect, unref(searchForm).status]
                            ])
                          ])
                        ]),
                        createVNode("button", {
                    ...
                    updateStatusModal.value ? (openBlock(), createBlock("div", { key: 1 }, [
                      createVNode("div", { class: "fixed inset-0 flex items-center justify-center z-50" }, [
                        createVNode("div", { class: "bg-white rounded-lg p-8" }, [
                          createVNode("h2", { class: "text-xl font-semibold mb-4" }, " Update Status "),
                          createVNode("form", {
                            onSubmit: withModifiers(statusUpdate, ["prevent"]),
                            method: "POST"
                          }, [
                            createVNode("div", { class: "mb-4" }, [
                              createVNode("label", {
                              ...
                              withDirectives(createVNode("select", {
                                ...
                                class: "border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full",
                                name: "first_semester",
                                "onUpdate:modelValue": ($event) => unref(downloadCertificateForm).first_sem_status = $event
                              }, [
                                createVNode("option", {
                                  value: "",
                                  hidden: ""
                                }, " Please Select Status "),
                                createVNode("option", { value: "passed" }, " Passed "),
                            ...
                            createVNode("div", { class: "mb-4" }, [
                              ...
                              withDirectives(createVNode("select", {
                                ...
                                "onUpdate:modelValue": ($event) => unref(downloadCertificateForm).second_sem_status = $event
                              }, [
                                createVNode("option", {
                                  value: "",
                                  hidden: ""
                            ...
                            createVNode("div", { class: "flex justify-end" }, [
                              createVNode("button", {
                                type: "button",
                                class: "py-2 px-4 bg-gray-500 hover:bg-gray-700 text-white rounded text-sm mr-2",
                                onClick: ($event) => updateStatusModal.value = false
                              }, " Cancel ", 8, ["onClick"]),
                              createVNode("button", {
                                type: "submit",
                      ...
                      createVNode("tbody", { class: "bg-white divide-y divide-gray-200" }, [
                        (openBlock(true), createBlock(Fragment, null, renderList(__props.students, (student) => {
                          return openBlock(), createBlock("tr", {
                            ...
                            createVNode("td", { class: "px-2 py-1 whitespace-nowrap text-xs" }, [
                              student.first_sem_status && student.second_sem_status ? (openBlock(), createBlock("div", {
                                key: 0,
                                class: "text-green-500"
                              }, " Complete ")) : (openBlock(), createBlock("div", {
                                key: 1,
                                class: "text-red-500"
                              }, " Incomplete "))
                            ]),
